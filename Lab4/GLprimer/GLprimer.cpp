...
int main(int, char*[]) {
   ...
   // TriangleSoup myShape;
    ...
    TriangleSoup myBox;
    myBox.createBox(0.2f, 0.2f, 1.0f);
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        std::array<GLfloat, 16> matP = mat4perspective(M_PI/4, 1.0f*2, 0.1f, 100.0f);
        ...
        glUniformMatrix4fv(locationE, 1, GL_FALSE, matE.data());  // Copy the value
